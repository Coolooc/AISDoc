		...
		<div class="table-scroll">
			<table class="table table-striped">
	            ...
	            for(Zakaz zakaz : zakazEJB.getAllDateASC()) {
	        		out.println("<tr>");
	        			out.println("<form action=\"orders-search.jsp\" method=\"post\">");
	        			out.println("<td><input type=\"text\" name=\"vhodnoiNomer\" hidden value=\"" + zakaz.getVhodnoiNomer() + "\">" + zakaz.getVhodnoiNomer() + "</td>");
	        			...
	        			out.println("<td><button class=\"btn btn-success main-oyd-btn\" type=\"submit\">Принять</button></td>");
	        			out.println("</form>");
	            	out.println("</tr>");
	        	}
	            %>
