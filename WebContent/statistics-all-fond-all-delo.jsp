...
<div class="container">
	<nav class="navbar navbar-default">
  	...
  	<div class="well">
<%
String title = "Количество всех дел по фондам";
	    ...
	    <div class="div-statistics-center">
		    ...
		    <script>
				...
				function drawChart() {
					...
					data.addColumn('string', 'Номер фонда');
					data.addColumn('number', 'Количество дел в фонде');
					data.addRows([
					  /* ['Фонд № 50', 33],
					  ['Фонд № 39', 67] */
					  <%
					  for (Object[] obj : topografiyaEJB.getCountNomerDelaFromNomerFonda()) {
					  	String nomerFonda = String.valueOf(obj[0]);
					  	String nomerDela = String.valueOf(obj[1]);
					  	out.println("['Фонд №" + nomerFonda + "'," + nomerDela + "],");
					  }
					  %>
					]);
					
					var piechart_options  = {'title':<% out.println("'" + title + "'"); %>, width:500, height:300};
					var piechart  = new google.visualization.PieChart(document.getElementById('piechart_div'));
					piechart.draw(data, piechart_options);
					
					var barchart_options = {title:<% out.println("'" + title + "'"); %>, width:500, height:500, legend: 'none'};
