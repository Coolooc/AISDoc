...
String title = "Количество дел относящихся к фонду №";
    	...
    	<div class="div-statistics-center">
		    ...
		    <script>
				...
				function drawChart() {
					...
					data.addColumn('string', 'Номер дела');
					data.addColumn('number', 'Копия дела в количестве');
					data.addRows([
					  /* ['Фонд № 50', 33],
					  ['Фонд № 39', 67] */
					  <%
					  for (Object[] obj : topografiyaEJB.getCountNomerDeloFromNomerFonda(nomerFond)) {
					      String nomerDela = String.valueOf(obj[0]);
						  String countDela = String.valueOf(obj[1]);
						  out.println("['Дело №" + nomerDela + "'," + countDela + "],");
					  }
					  %>
					]);
